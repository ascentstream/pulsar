...
public class ResourceGroupRateLimiterManager {
    ...
    static ResourceGroupDispatchLimiter newReplicationDispatchRateLimiter(
        ...
        return newReplicationDispatchRateLimiter(msgs, bytes);
    }

    static ResourceGroupDispatchLimiter newReplicationDispatchRateLimiter(long msgs, long bytes) {
        return new ResourceGroupDispatchLimiter(msgs, bytes);
    }
