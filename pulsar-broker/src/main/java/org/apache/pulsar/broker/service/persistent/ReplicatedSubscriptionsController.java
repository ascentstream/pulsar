...
public class ReplicatedSubscriptionsController implements AutoCloseable, Topic.PublishContext {
    ...
    private static final Counter snapshotOperationCounter = Counter
            .build("pulsar_broker_replication_subscription_snapshot_operation",
                    "The number of snapshot operations attempted")
            .register();

    private static final Counter writtenMarkerMessageCounter = Counter
            .build("pulsar_broker_replication_marker_messages_written",
    ...
    private static final Counter receivedMarkerMessageCounter = Counter
            .build("pulsar_broker_replication_marker_messages_received",
