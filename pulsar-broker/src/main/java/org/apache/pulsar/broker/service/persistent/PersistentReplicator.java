...
public abstract class PersistentReplicator extends AbstractReplicator
    ...
    public void readEntriesComplete(List<Entry> entries, Object ctx) {
        ...
        ReplicationStatus replicationStatus = replicateEntries(entries, inFlightTask);
    ...
    protected abstract ReplicationStatus replicateEntries(List<Entry> entries, InFlightTask inFlightTask);
