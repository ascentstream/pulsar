...
public class ProxyConnection extends PulsarHandler {
    ...
    private synchronized void completeConnect() throws PulsarClientException {
        ...
        String maybeAnonymizedOriginalAuthRole = originalAuthRole;
        ...
        if (hasProxyToBrokerUrl) {
            ...
            if (service.getConfiguration().isCheckActiveBrokers()
                ...
                LOG.warn("[{}] Target broker '{}' isn't available. client authenticated with {} role {}, "
                        ...
                        remoteAddress, proxyToBrokerUrl, clientAuthMethod, clientAuthRole,
                        originalAuthMethod, originalAuthRole);
                    ...
                    .exceptionally(throwable -> {
                        if (throwable instanceof TargetAddressDeniedException
                            ...
                            LOG.warn(
                                    ...
                                    clientAuthMethod, clientAuthRole, originalAuthMethod,
                                    originalAuthRole);
                        } else {
